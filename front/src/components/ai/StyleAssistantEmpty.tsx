...
export function StyleAssistantEmpty() {
  return (
    <section
      aria-labelledby="style-assistant-empty-title"
      className={`${styles.stateCard} ${styles.emptyCard}`}
    >
      <FashionIllustration />
      <div className={styles.emptyCopy}>
        ...
        <p>
          Share the mood, occasion, color, or budget you have in mind. Your
          personalized Belikeme edit will appear here.
        </p>
      </div>
    </section>
  );
...
export function FashionIllustration({ compact = false }: { compact?: boolean }) {
  return (
    <div
      aria-hidden="true"
      className={`${styles.illustration} ${compact ? styles.illustrationCompact : ""}`}
    >
      <svg fill="none" viewBox="0 0 420 360" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          d="M185 119C185 105.193 196.193 94 210 94C223.807 94 235 105.193 235 119V130H185V119Z"
          fill="currentColor"
        />
