...
const VIETNAMESE_SIGNALS: LanguageSignal[] = [
  ...
  { pattern: /\bthuong\s+ngay\b/, weight: 2 },
  { pattern: /\b(?:don\s+gian|toi\s+gian|de\s+mac)\b/, weight: 2 },
  { pattern: /\b(?:ao\s+khoac|ao\s+tay\s+dai|trang\s+suc)\b/, weight: 2 },
  { pattern: /\b(?:re\s+hon|tiet\s+kiem|gia\s+mem|thay)\b/, weight: 2 },
