...
const SUPPORT_SCOPE_PATTERN =
  /\b(?:belikeme|support|help|hello|hi|shipping|shipment|delivery|return|refund|exchange|size guide|sizing|wrong size|wrong item|incorrect item|damaged|broken|defective|doesn['’]?t fit|too small|too large|changed my mind|change of mind|measurement|order|ordered|payment status|paid|tracking|track|package|parcel|purchase|status|handoff|human support|customer service|ho tro|xin chao|giao hang|van chuyen|doi tra|hoan tien|doi hang|bang size|kich co|don hang|thanh toan|trang thai|ma van don|nhan vien)\b/i;
