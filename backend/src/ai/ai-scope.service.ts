...
const STYLE_SCOPE_PATTERN =
  /\b(?:outfit|clothes?|clothing|fashion|style|styling|wear|dress|shirt|t-?shirt|tee|top|pants|trousers|jeans|skirt|jacket|coat|hoodie|sweater|cardigan|blazer|shorts|boots?|shoes?|sneakers?|bags?|handbags?|accessor(?:y|ies)|silver accessories|fit|fitting|loose|layers?|oversized|minimal|casual|daily|formal|smart casual|streetwear|gothic|darkwear|grunge|punk|vintage|classic|sporty|monochrome|neutral|comfortable|elegant|color match|colour match|layering|wardrobe|occasion|wedding|party|school|work|office|going out|body type|belikeme|rick owens|under|below|trang phuc|quan ao|thoi trang|phong cach|mac gi|ao|quan|vay|dam|giay|tui|phu kien|ao thun|ao tay dai|ao khoac|phoi do|di choi|di cafe|mau den|mau xanh|xanh|bac|don gian|toi gian|de mac|hang ngay|thuong ngay|khong qua noi|khong loe loet|khong qua lo|re hon|tiet kiem|gia mem|form rong|mau sac|vua van|di tiec|di hoc|di lam)\b/i;
